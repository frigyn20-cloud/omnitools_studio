...
const tools: Tool[] = [
  ...
  { id: "pdf-annotate", slug: "pdf-signature-text-tool", category: "utilities", name: "PDF Signature & Text", description: "Add text and signatures to any PDF in your browser.", icon: PenLine, keyword: "pdf signature tool online", example: "Use it to upload a PDF, place text annotations, draw a signature, and download the annotated file." },
];